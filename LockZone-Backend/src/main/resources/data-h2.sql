...
insert into Users(username,password,enabled,master_id) values('danny','$2a$10$cdgz.UZwwTnvQsjGLgJ98./0FGov/rvmXJH2et2mRZy.SZYiDpgWa', true,1);
...
insert into authorities values('danny', 'ROLE_USER');
